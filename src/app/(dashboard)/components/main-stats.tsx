...
export const MainStats = ({ clients, plans }: { clients: Client[]; plans: { plan: Plan; price: number }[] }) => {
  ...
  const planValues = plans.reduce((acc, { plan, price }) => {
    acc[plan] = price;
    return acc;
  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <StatCard
        ...
        description="from visitors to clients"
        icon={TrendingUp}
      />
